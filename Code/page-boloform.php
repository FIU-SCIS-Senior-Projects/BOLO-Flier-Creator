...
<!-- Including The Header of the Agency --	
<!-- Category -->
<!-- Upload Image Button -->
<!-- Title - Select Basic -->
<!-- Name - Text input-->
...
<!-- Height - Text input-->
<!-- Weight - Text input-->
<!-- Hair Color - Select Basic -->
<!-- Tattoos/Scars Textarea -->
<!-- Address Text input-->
<!-- Additional Information Textarea -->
<!-- Summary Textarea -->
<!-- Source Reliability Multiple Checkboxes (inline) -->
<!-- Content Validity Multiple Checkboxes (inline) -->
<!-- Information Classification Multiple Checkboxes (inline) -->
<!-- Submit Button -->
 */
...
<div class="control-group">
  ...
  <div class="controls">
    <select id="title" name="title" class="input-xlarge">
     <option value =""></option>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="dob" name="dob" placeholder="" class="input-xlarge" type="date">
