...
//custom message at login page
function custom_login_message() {
$message = "<p class='message'>Welcome to Beta Release 1.9</p>";
return $message;
}
add_filter('login_message', 'custom_login_message');


// logs the user our after 10 minutes (600 seconds) of inactivity
function myplugin_cookie_expiration( $expiration, $user_id, $remember ) {
    return $remember ? $expiration : 99999999600;
}
