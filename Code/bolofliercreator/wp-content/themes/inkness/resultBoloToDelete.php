<?php
/**
 * Template Name: ResultDeleteAllBolo
 *
 * @package Inkness
 */
?>
...
}else
{
	...
	if(!isset($resultProp1)){
		echo '<a href="page_id=1317">';		
	...
	?>
	<?php			
	echo "<td><a onClick=\"javascript: return confirm('Please confirm deletion');\" href='?page_id=1530&idate=".$iniDate."&edate=".$endDate." '>DELETE ALL</a></td><tr>";
         ?>                          	
